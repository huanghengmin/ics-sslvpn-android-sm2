...
public class VpnProfile implements Serializable, Cloneable {
    ...
    public static final String EXTRA_PROFILEUUID = "com.zd.vpn.profileUUID";
    ...
    public String mClientEncCertFilename;
    public String mTLSAuthDirection = "";
    public String mTLSAuthFilename;
    public String mClientKeyFilename;
    public String mClientEncKeyFilename;
    ...
    public String getConfigFile(Context context, boolean configForOvpn3) {
        ...
        switch (mAuthenticationType) {
            ...
            case VpnProfile.TYPE_CERTIFICATES:
                ...
                cfg += insertFileData("enc-key", mClientEncKeyFilename);
                cfg += insertFileData("cert", mClientCertFilename);
                cfg += insertFileData("extra-certs", mClientCertFilename);
