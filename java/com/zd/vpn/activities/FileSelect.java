...
import com.zd.vpn.fragments.FileSelectionFragment;
import com.zd.vpn.fragments.InlineFileTab;
...
public class FileSelect extends BaseActivity {
	...
	public static final String NO_INLINE_SELECTION = "com.zd.vpn.NO_INLINE_SELECTION";
	public static final String SHOW_CLEAR_BUTTON = "com.zd.vpn.SHOW_CLEAR_BUTTON";
	public static final String DO_BASE64_ENCODE = "com.zd.vpn.BASE64ENCODE";
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(com.zd.vpn.R.layout.file_dialog);
		...
		fileExplorerTab = bar.newTab().setText(com.zd.vpn.R.string.file_explorer_tab);
		inlineFileTab = bar.newTab().setText(com.zd.vpn.R.string.inline_file_tab);
	...
	public void importFile(String path) {
		...
		if(fe!=null) {
			...
			ab.setTitle(com.zd.vpn.R.string.error_importing_file);
			ab.setMessage(getString(com.zd.vpn.R.string.import_error_message) + "\n" + fe.getLocalizedMessage());
