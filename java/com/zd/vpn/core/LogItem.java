    ...
    public String getString(Context c) {
        try {
            if (mMessage != null) {
                ...
                if (c != null) {
                    if (mRessourceId == com.zd.vpn.R.string.mobile_info)
    ...
    private String getMobileInfoString(Context c) {
        ...
        try {
            ...
            if (Arrays.equals(digest, VpnStatus.officalkey))
                apksign = c.getString(com.zd.vpn.R.string.official_build);
            else if (Arrays.equals(digest, VpnStatus.officaldebugkey))
                apksign = c.getString(com.zd.vpn.R.string.debug_build);
                ...
                apksign = c.getString(com.zd.vpn.R.string.built_by, cert.getSubjectX500Principal().getName());
        ...
        return c.getString(com.zd.vpn.R.string.mobile_info, argsext);
