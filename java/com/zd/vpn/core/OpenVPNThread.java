...
//    private static final String BROKEN_PIE_SUPPORT = "/data/data/com.zd.vpn/cache/pievpn";
    private static final String BROKEN_PIE_SUPPORT = "/data/data/com.zd.vpn/cache/pievpn";
    ...
    public void run() {
        try {
            ...
            if (!mNoProcessExitStatus)
                VpnStatus.updateStateString("NOPROCESS", "No process running.", com.zd.vpn.R.string.state_noprocess, ConnectionStatus.LEVEL_NOTCONNECTED);
            ...
            if (mDumpPath != null) {
                try {
                    ...
                    logout.close();
                    VpnStatus.logError(com.zd.vpn.R.string.minidump_generated);
                } catch (IOException e) {
