...
public class VpnStatus {
    ...
    private static int mLastStateresid = com.zd.vpn.R.string.state_noprocess;
    ...
    public static void logException(LogLevel ll, String context, Exception e) {
        ...
        LogItem li;
        if (context != null) {
            li = new LogItem(ll, com.zd.vpn.R.string.unhandled_exception_context, e.getMessage(), sw.toString(), context);
        } else {
            li = new LogItem(ll, com.zd.vpn.R.string.unhandled_exception, e.getMessage(), sw.toString());
        }
        newLogItem(li);
    }
...
*/
        ...
        if (mLastStateresid == com.zd.vpn.R.string.state_waitconnectretry) {
            return c.getString(com.zd.vpn.R.string.state_waitconnectretry, mLaststatemsg);
        }

        String prefix = c.getString(mLastStateresid);
        if (mLastStateresid == com.zd.vpn.R.string.unknown_state)
    ...
    // keytool -printcert -jarfile com.zd.vpn_85.apk
    ...
    private static void logInformation() {
        ...
        logInfo(com.zd.vpn.R.string.mobile_info, Build.MODEL, Build.BOARD, Build.BRAND, Build.VERSION.SDK_INT,
    ...
    private static int getLocalizedState(String state) {
        switch (state) {
            case "CONNECTING":
                return com.zd.vpn.R.string.state_connecting;
            case "WAIT":
                return com.zd.vpn.R.string.state_wait;
            case "AUTH":
                return com.zd.vpn.R.string.state_auth;
            case "GET_CONFIG":
                return com.zd.vpn.R.string.state_get_config;
            case "ASSIGN_IP":
                return com.zd.vpn.R.string.state_assign_ip;
            case "ADD_ROUTES":
                return com.zd.vpn.R.string.state_add_routes;
            case "CONNECTED":
                return com.zd.vpn.R.string.state_connected;
            case "DISCONNECTED":
                return com.zd.vpn.R.string.state_disconnected;
            case "RECONNECTING":
                return com.zd.vpn.R.string.state_reconnecting;
            case "EXITING":
                return com.zd.vpn.R.string.state_exiting;
            case "RESOLVE":
                return com.zd.vpn.R.string.state_resolve;
            case "TCP_CONNECT":
                return com.zd.vpn.R.string.state_tcp_connect;
            default:
                return com.zd.vpn.R.string.unknown_state;
        }
    ...
    public static void updateStatePause(OpenVPNManagement.pauseReason pauseReason) {
        switch (pauseReason) {
            case noNetwork:
                VpnStatus.updateStateString("NONETWORK", "", com.zd.vpn.R.string.state_nonetwork, ConnectionStatus.LEVEL_NONETWORK);
                break;
            case screenOff:
                VpnStatus.updateStateString("SCREENOFF", "", com.zd.vpn.R.string.state_screenoff, ConnectionStatus.LEVEL_VPNPAUSED);
                break;
            case userPause:
                VpnStatus.updateStateString("USERPAUSE", "", com.zd.vpn.R.string.state_userpause, ConnectionStatus.LEVEL_VPNPAUSED);
                break;
        }
