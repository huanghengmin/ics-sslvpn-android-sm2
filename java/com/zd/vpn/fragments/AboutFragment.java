...
public class AboutFragment extends Fragment implements View.OnClickListener {
    ...
    private void createPlayBuyOptions(ArrayList<String> ownedSkus, ArrayList<String> responseList) {
        try {
            ...
            gdonation.add(new Pair<String, String>(getString(com.zd.vpn.R.string.donatePlayStore),null));
    ...
    private Pair<String,String> getSkuTitle(final String sku, String title, String price, ArrayList<String> ownedSkus) {
        ...
        if (ownedSkus.contains(sku))
            return new Pair<String,String>(getString(com.zd.vpn.R.string.thanks_for_donation, price),null);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.zd.vpn.R.layout.about, container, false);
        TextView ver = (TextView) v.findViewById(com.zd.vpn.R.id.version);
        ...
        try {
            ...
            name = getString(com.zd.vpn.R.string.app);
        } catch (NameNotFoundException e) {
            version = "error fetching version";
        }


        ver.setText(getString(com.zd.vpn.R.string.version_info, name, version));



        gmsTextView = (TextView) v.findViewById(com.zd.vpn.R.id.donategms);
        ...
        TextView translation = (TextView) v.findViewById(com.zd.vpn.R.id.translation);

        // Don't print a text for myself
        if (getString(com.zd.vpn.R.string.translationby).contains("Arne Schwabe"))
            translation.setText("");
        else
            translation.setText(com.zd.vpn.R.string.translationby);

        WebView wv = (WebView)v.findViewById(com.zd.vpn.R.id.webView);
