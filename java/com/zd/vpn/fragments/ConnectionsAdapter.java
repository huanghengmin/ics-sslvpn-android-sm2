...
import com.zd.vpn.core.Connection;
...
public class ConnectionsAdapter extends RecyclerView.Adapter<ConnectionsAdapter.ConnectionsHolder> {
    ...
    class ConnectionsHolder extends RecyclerView.ViewHolder {
        ...
        ConnectionsHolder(View card, ConnectionsAdapter connectionsAdapter, int viewType) {
            super(card);
            mServerNameView = (EditText) card.findViewById(com.zd.vpn.R.id.servername);
            mPortNumberView = (EditText) card.findViewById(com.zd.vpn.R.id.portnumber);
            mRemoteSwitch = (Switch) card.findViewById(com.zd.vpn.R.id.remoteSwitch);
            mCustomOptionCB = (CheckBox) card.findViewById(com.zd.vpn.R.id.use_customoptions);
            mCustomOptionText = (EditText) card.findViewById(com.zd.vpn.R.id.customoptions);
            mProtoGroup = (RadioGroup) card.findViewById(com.zd.vpn.R.id.udptcpradiogroup);
            mCustomOptionsLayout = card.findViewById(com.zd.vpn.R.id.custom_options_layout);
            mDeleteButton = (ImageButton) card.findViewById(com.zd.vpn.R.id.remove_connection);
            mConnectSlider = (SeekBar) card.findViewById(com.zd.vpn.R.id.connect_silder);
            mConnectText = (EditText) card.findViewById(com.zd.vpn.R.id.connect_timeout);
        ...
        void addListeners() {
            ...
            mProtoGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(RadioGroup group, int checkedId) {
                    if (mConnection != null) {
                        if (checkedId == com.zd.vpn.R.id.udp_proto)
                            mConnection.mUseUdp = true;
                        else if (checkedId == com.zd.vpn.R.id.tcp_proto)
            ...
            mDeleteButton.setOnClickListener(
                    new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            ab.setTitle(com.zd.vpn.R.string.query_delete_remote);
                            ab.setPositiveButton(com.zd.vpn.R.string.keep, null);
                            ab.setNegativeButton(com.zd.vpn.R.string.delete, new DialogInterface.OnClickListener() {
                                @Override
    ...
    public ConnectionsAdapter.ConnectionsHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View card;
        if (viewType == TYPE_NORMAL) {
            card = li.inflate(com.zd.vpn.R.layout.server_card, viewGroup, false);

        } else { // TYPE_FOOTER
            card = li.inflate(com.zd.vpn.R.layout.server_footer, viewGroup, false);
        }
    ...
    public void onBindViewHolder(final ConnectionsAdapter.ConnectionsHolder cH, int position) {
        ...
        cH.mProtoGroup.check(connection.mUseUdp ? com.zd.vpn.R.id.udp_proto : com.zd.vpn.R.id.tcp_proto);
