...
public class FaqViewAdapter extends RecyclerView.Adapter<FaqViewAdapter.FaqViewHolder> {
    ...
    private void fetchStrings(FaqFragment.FAQEntry[] faqItems) {
        for (int i =0; i < faqItems.length; i++) {
            ...
            if (faqItems[i].title == com.zd.vpn.R.string.faq_system_dialogs_title)
            {
                Spanned xPosedtext = Html.fromHtml(textColor + mContext.getString(com.zd.vpn.R.string.faq_system_dialog_xposed));
    ...
    public static class FaqViewHolder extends RecyclerView.ViewHolder {
        ...
        public FaqViewHolder(View itemView) {
            ...
            mBody = (TextView)mView.findViewById(com.zd.vpn.R.id.faq_body);
            mHead = (TextView)mView.findViewById(com.zd.vpn.R.id.faq_head);
    ...
    public FaqViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(com.zd.vpn.R.layout.faqcard, viewGroup, false);
