...
public class InlineFileTab extends Fragment
{
			...
			Bundle savedInstanceState)
	{
		...
		View v = inflater.inflate(com.zd.vpn.R.layout.file_dialog_inline, container, false);
		mInlineData =(EditText) v.findViewById(com.zd.vpn.R.id.inlineFileData);
		return v;
	}
	...
	public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
		menu.add(0, MENU_SAVE, 0, com.zd.vpn.R.string.menu_use_inline_data)
