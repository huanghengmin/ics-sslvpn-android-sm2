...
public class SendDumpFragment extends Fragment  {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final View v = inflater.inflate(com.zd.vpn.R.layout.fragment_senddump, container, false);
		v.findViewById(com.zd.vpn.R.id.senddump).setOnClickListener(new OnClickListener() {
		...
		new Thread(new Runnable() {
			...
			public void run() {
				...
				getActivity().runOnUiThread(new Runnable() {
					@Override
					public void run() {
						TextView dumpDateText = (TextView) v.findViewById(com.zd.vpn.R.id.dumpdate);
						...
						dumpDateText.setText(getString(com.zd.vpn.R.string.lastdumpdate, hours, minutes, datestr));
