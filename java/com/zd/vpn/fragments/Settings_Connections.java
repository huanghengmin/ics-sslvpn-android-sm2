...
public class Settings_Connections extends Settings_Fragment implements View.OnClickListener {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP)
            inflater.inflate(com.zd.vpn.R.menu.connections, menu);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(com.zd.vpn.R.layout.connections, container, false);

        mWarning = (TextView) v.findViewById(com.zd.vpn.R.id.noserver_active_warning);
        mRecyclerView = (RecyclerView) v.findViewById(com.zd.vpn.R.id.connection_recycler_view);
        ...
        ImageButton fab_button = (ImageButton) v.findViewById(com.zd.vpn.R.id.add_new_remote);
        if(fab_button!=null)
                fab_button.setOnClickListener(this);

        mUseRandomRemote = (Checkable) v.findViewById(com.zd.vpn.R.id.remote_random);
    ...
    public void onClick(View v) {
        if (v.getId() == com.zd.vpn.R.id.add_new_remote) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId()== com.zd.vpn.R.id.add_new_remote)
            mConnectionsAdapter.addRemote();
