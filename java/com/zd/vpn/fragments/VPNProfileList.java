...
public class VPNProfileList extends ListFragment implements OnClickListener, VpnStatus.StateListener {
    ...
    class VPNArrayAdapter extends ArrayAdapter<VpnProfile> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            View titleview = v.findViewById(com.zd.vpn.R.id.vpn_list_item_left);
            ...
            View settingsview = v.findViewById(com.zd.vpn.R.id.quickedit_settings);
            ...
            TextView subtitle = (TextView) v.findViewById(com.zd.vpn.R.id.vpn_item_subtitle);
    ...
    class MiniImageGetter implements ImageGetter {
        ...
        public Drawable getDrawable(String source) {
            ...
            if ("ic_menu_add".equals(source))
                d = getActivity().getResources().getDrawable(com.zd.vpn.R.drawable.ic_menu_add_grey);
            else if ("ic_menu_archive".equals(source))
                d = getActivity().getResources().getDrawable(com.zd.vpn.R.drawable.ic_menu_import_grey);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.zd.vpn.R.layout.vpn_profile_list, container, false);

        TextView newvpntext = (TextView) v.findViewById(com.zd.vpn.R.id.add_new_vpn_hint);
        TextView importvpntext = (TextView) v.findViewById(com.zd.vpn.R.id.import_vpn_hint);

        newvpntext.setText(Html.fromHtml(getString(com.zd.vpn.R.string.add_new_vpn_hint), new MiniImageGetter(), null));
        importvpntext.setText(Html.fromHtml(getString(com.zd.vpn.R.string.vpn_import_hint), new MiniImageGetter(), null));

        ImageButton fab_add = (ImageButton) v.findViewById(com.zd.vpn.R.id.fab_add);
        ImageButton fab_import = (ImageButton) v.findViewById(com.zd.vpn.R.id.fab_import);
        if (fab_add != null)
    ...
    private void setListAdapter() {
        if (mArrayadapter == null) {
            mArrayadapter = new VPNArrayAdapter(getActivity(), com.zd.vpn.R.layout.vpn_list_item, com.zd.vpn.R.id.vpn_item_title);
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        menu.add(0, MENU_ADD_PROFILE, 0, com.zd.vpn.R.string.menu_add_profile)
                .setIcon(com.zd.vpn.R.drawable.ic_menu_add)
                .setAlphabeticShortcut('a')
                .setTitleCondensed(getActivity().getString(com.zd.vpn.R.string.add))
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);

        menu.add(0, MENU_IMPORT_PROFILE, 0, com.zd.vpn.R.string.menu_import)
                .setIcon(com.zd.vpn.R.drawable.ic_menu_import)
                .setAlphabeticShortcut('i')
                .setTitleCondensed(getActivity().getString(com.zd.vpn.R.string.menu_import_short))
                .setShowAsAction(MenuItem.SHOW_AS_ACTION_ALWAYS);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.zd.vpn.R.id.fab_import:
                startImportConfigFilePicker();
                break;
            case com.zd.vpn.R.id.fab_add:
                onAddOrDuplicateProfile(null);
                break;
        }
    }
    ...
    private void startImportConfig() {
        ...
        intent.putExtra(FileSelect.WINDOW_TITLE, com.zd.vpn.R.string.import_configuration_file);
    ...
    private void onAddOrDuplicateProfile(final VpnProfile mCopyProfile) {
        ...
        if (context != null) {
            ...
            if (mCopyProfile == null)
                dialog.setTitle(com.zd.vpn.R.string.menu_add_profile);
            else {
                dialog.setTitle(context.getString(com.zd.vpn.R.string.duplicate_profile_title, mCopyProfile.mName));
                entry.setText(getString(com.zd.vpn.R.string.copy_of_profile, mCopyProfile.mName));
            }

            dialog.setMessage(com.zd.vpn.R.string.add_profile_name_prompt);
            dialog.setView(entry);

            dialog.setNeutralButton(com.zd.vpn.R.string.menu_import_short,
                    ...
                    new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (getPM().getProfileByName(name) == null) {
                                ...
                                Toast.makeText(getActivity(), com.zd.vpn.R.string.duplicate_profile_name, Toast.LENGTH_LONG).show();
                            }
                        }
