...
public class PagerSlidingTabStrip extends HorizontalScrollView implements TabBarView {
    ...
    private int tabBackgroundResId = com.zd.vpn.R.drawable.slidingtab_background;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        // get custom attrs
        a = context.obtainStyledAttributes(attrs, com.zd.vpn.R.styleable.PagerSlidingTabStrip);
        indicatorColor = a.getColor(com.zd.vpn.R.styleable.PagerSlidingTabStrip_pstsIndicatorColor, indicatorColor);
        underlineColor = a.getColor(com.zd.vpn.R.styleable.PagerSlidingTabStrip_pstsUnderlineColor, underlineColor);
        dividerColor = a.getColor(com.zd.vpn.R.styleable.PagerSlidingTabStrip_pstsDividerColor, dividerColor);
        dividerWidth = a.getDimensionPixelSize(com.zd.vpn.R.styleable.PagerSlidingTabStrip_pstsDividerWidth, dividerWidth);
        indicatorHeight = a.getDimensionPixelSize(com.zd.vpn.R.styleable.PagerSlidingTabStrip_pstsIndicatorHeight, indicatorHeight);
        underlineHeight = a.getDimensionPixelSize(com.zd.vpn.R.styleable.PagerSlidingTabStrip_pstsUnderlineHeight, underlineHeight);
        dividerPadding = a.getDimensionPixelSize(com.zd.vpn.R.styleable.PagerSlidingTabStrip_pstsDividerPadding, dividerPadding);
        tabPadding = a.getDimensionPixelSize(com.zd.vpn.R.styleable.PagerSlidingTabStrip_pstsTabPaddingLeftRight, tabPadding);
        tabBackgroundResId = a.getResourceId(com.zd.vpn.R.styleable.PagerSlidingTabStrip_pstsTabBackground, tabBackgroundResId);
        shouldExpand = a.getBoolean(com.zd.vpn.R.styleable.PagerSlidingTabStrip_pstsShouldExpand, shouldExpand);
        scrollOffset = a.getDimensionPixelSize(com.zd.vpn.R.styleable.PagerSlidingTabStrip_pstsScrollOffset, scrollOffset);
        textAllCaps = a.getBoolean(com.zd.vpn.R.styleable.PagerSlidingTabStrip_pstsTextAllCaps, textAllCaps);
        isPaddingMiddle = a.getBoolean(com.zd.vpn.R.styleable.PagerSlidingTabStrip_pstsPaddingMiddle, isPaddingMiddle);
        tabTypefaceStyle = a.getInt(com.zd.vpn.R.styleable.PagerSlidingTabStrip_pstsTextStyle, Typeface.BOLD);
        tabTypefaceSelectedStyle = a.getInt(com.zd.vpn.R.styleable.PagerSlidingTabStrip_pstsTextSelectedStyle, Typeface.BOLD);
        tabTextAlpha = a.getFloat(com.zd.vpn.R.styleable.PagerSlidingTabStrip_pstsTextAlpha, HALF_TRANSP);
        tabTextSelectedAlpha = a.getFloat(com.zd.vpn.R.styleable.PagerSlidingTabStrip_pstsTextSelectedAlpha, OPAQUE);
        a.recycle();
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < tabCount; i++) {
            ...
            if (pager.getAdapter() instanceof CustomTabProvider) {
                ...
                tabView = LayoutInflater.from(getContext()).inflate(com.zd.vpn.R.layout.padersliding_tab, this, false);
            }
    ...
    private void addTab(final int position, CharSequence title, View tabView) {
        TextView textView = (TextView) tabView.findViewById(com.zd.vpn.R.id.tab_title);
        if (textView != null) {
    ...
    private void updateTabStyles() {
        for (int i = 0; i < tabCount; i++) {
            ...
            TextView tab_title = (TextView) v.findViewById(com.zd.vpn.R.id.tab_title);
    ...
    private void notSelected(View tab) {
        TextView title = (TextView) tab.findViewById(com.zd.vpn.R.id.tab_title);
        if (title != null) {
