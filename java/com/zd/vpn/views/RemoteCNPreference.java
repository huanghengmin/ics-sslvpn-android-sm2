...
public class RemoteCNPreference extends DialogPreference {
	...
	public RemoteCNPreference(Context context, AttributeSet attrs) {
		super(context, attrs);
		setDialogLayoutResource(com.zd.vpn.R.layout.tlsremote);
	...
	protected void onBindDialogView(View view) {
		...
		mEditText = (EditText) view.findViewById(com.zd.vpn.R.id.tlsremotecn);
		mSpinner = (Spinner) view.findViewById(com.zd.vpn.R.id.x509verifytype);
		mRemoteTLSNote = (TextView) view.findViewById(com.zd.vpn.R.id.tlsremotenote);
	...
	private void populateSpinner() {
		...
		authtypes.add(getContext().getString(com.zd.vpn.R.string.complete_dn));
		authtypes.add(getContext().getString(com.zd.vpn.R.string.rdn));
		authtypes.add(getContext().getString(com.zd.vpn.R.string.rdn_prefix));
		if ((mDNType == VpnProfile.X509_VERIFY_TLSREMOTE || mDNType == VpnProfile.X509_VERIFY_TLSREMOTE_COMPAT_NOREMAPPING)
				&& !(mDn==null || "".equals(mDn))) {
			authtypes.add(getContext().getString(com.zd.vpn.R.string.tls_remote_deprecated));
